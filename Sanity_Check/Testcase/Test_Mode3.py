...
class Test_Mode3(TestCase):
    ...
    def test_1(self):
        ...
        # 截取拍摄前患者信息
        patient_info = "/%s/current/拍摄界面截图/新建患者-0808高清-%s.png" % (self.image_path,time_str)
        ...
        if dingwei == 2:
            ...
            # 选取0808高清模式
            autoit.mouse_click("left", 1779, 244)
            time.sleep(2)
        ...
        # 截取高清拍摄中预览图
        gry_current_image = "/%s/current/0808/高清拍摄中预览图%s.png" % (self.image_path,timestring)
